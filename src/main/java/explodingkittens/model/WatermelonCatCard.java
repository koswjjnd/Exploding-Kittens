...
/**
 * Represents a Watermelon Cat card in the Exploding Kittens game.
 * Watermelon Cat cards can be used to steal any card from other players,
 * regardless of the card type.
 */
public class WatermelonCatCard extends CatCard {
    
    public WatermelonCatCard() {
        super(CatType.WATERMELON_CAT);
    }
