...
class MainTest {
    ...
    void setUpStreams() {
        ...
        PrintStream combinedStream = new PrintStream(outContent, true, StandardCharsets.UTF_8);
    ...
    void testMainNormalPath() {
        ...
        System.out.println("[TEST OUTPUT] " + outContent.toString(StandardCharsets.UTF_8));
    }
    ...
    void testGameCtrlStartIsCovered() {
        ...
        PrintStream combined = new PrintStream(outContent, true, StandardCharsets.UTF_8);
